...
from finsim.models import SimulationInput
from finsim.simulation import MonteCarloSimulator
...
def test_simulation_high_withdrawal_depletes():
    ...
    params = SimulationInput(
        ...
        target_monthly_income=10_000,  # Very high relative to capital
...
def test_simulation_low_withdrawal_succeeds():
    ...
    params = SimulationInput(
        ...
        target_monthly_income=3000,  # ~1.8% withdrawal rate
        social_security_monthly=2000,
        current_age=65,
        n_simulations=100,
        n_years=30,
