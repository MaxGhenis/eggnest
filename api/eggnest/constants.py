"""Shared constants for EggNest simulation and tax calculations."""

# State FIPS codes (two-letter abbreviation -> integer FIPS code)
...
FILING_STATUS_PE_SITUATION: dict[str, str] = {
    "single": "SINGLE",
