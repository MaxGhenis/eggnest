                ...
                {ssTimingResult.results.map((r) => (
                  <tr key={r.claiming_age}
                    ...
                    <td className="font-medium">
                      ...
                      {r.claiming_age === ssTimingResult.highest_success_claiming_age && <span className="ml-1 rounded bg-[var(--color-success)] px-1.5 py-0.5 text-[0.6rem] font-bold text-white">Highest success</span>}
                    </td>
                ...
                {allocationResult.results.map((r) => (
                  <tr key={r.stock_allocation} className={r.stock_allocation === allocationResult.highest_success_allocation ? "!bg-[var(--color-success-light)]" : ""}>
                    <td className="font-medium">
                      ...
                      {r.stock_allocation === allocationResult.highest_success_allocation && <span className="ml-1 rounded bg-[var(--color-success)] px-1.5 py-0.5 text-[0.6rem] font-bold text-white">Highest success</span>}
                    </td>
                    <td style={{
